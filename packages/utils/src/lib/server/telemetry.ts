...
/**
 * Experimental attribute, see {@link https://github.com/open-telemetry/opentelemetry-js/blob/main/semantic-conventions/README.md#unstable-semconv}.
 */
 ...
 * @example
 * // Custom attributes.
 * @trace({ kind: SpanKind.CLIENT, attributes: { [ATTR_SERVICE_PEER_NAME]: 'their-remote-service' } })
 * myFunction() { ... }
 * @example
